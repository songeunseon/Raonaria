...
#songender .gd{
    ...
    #songender #genderM[type='radio']:checked + label {
        background: #0d6efd;
        color: #fff;
    }
    #songender #genderW[type='radio']:checked + label {
        background: #f35b56;
        color: #fff;
    }
    #songender #genderM[type='radio']:not(:checked) + label {
        background: #fff;
        color: #0d6efd;
    }
    #songender #genderW[type='radio']:not(:checked) + label {
        background: #fff;
        color: #f35b56;
    }
.boxlist{
